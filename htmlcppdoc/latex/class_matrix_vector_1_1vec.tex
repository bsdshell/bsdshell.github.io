...
\index{Matrix\+Vector\+::vec@{Matrix\+Vector\+::vec}!vec@{vec}}
\index{vec@{vec}!Matrix\+Vector\+::vec@{Matrix\+Vector\+::vec}}
\subsubsection{\texorpdfstring{vec()}{vec()}}
{\footnotesize\ttfamily Matrix\+Vector\+::vec\+::vec (\begin{DoxyParamCaption}\item[{int}]{col,  }\item[{int}]{row = {\ttfamily 1} }\end{DoxyParamCaption})}
